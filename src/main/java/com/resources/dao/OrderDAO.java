...
public class OrderDAO {
    ...
    // ============================================================
    // FIXED: MOVE METHODS USING queueNumber + customerId
    // ============================================================
    
    public Order moveToPending(int queueNumber, int customerId) throws SQLException {
        return moveOrderByIdentifiers(queueNumber, customerId, "set_pricing_orders", "pending_orders", "pending");
    }
    
    public Order moveToWash(int queueNumber, int customerId) throws SQLException {
        return moveOrderByIdentifiers(queueNumber, customerId, "pending_orders", "to_wash_orders", "to_wash");
    }
    
    public Order moveToDry(int queueNumber, int customerId) throws SQLException {
        return moveOrderByIdentifiers(queueNumber, customerId, "to_wash_orders", "to_dry_orders", "to_dry");
    }
    
    public Order moveToIron(int queueNumber, int customerId) throws SQLException {
        return moveOrderByIdentifiers(queueNumber, customerId, "to_dry_orders", "to_iron_orders", "to_iron");
    }
    
    public Order moveToFold(int queueNumber, int customerId) throws SQLException {
        return moveOrderByIdentifiers(queueNumber, customerId, "to_iron_orders", "to_fold_orders", "to_fold");
    }
    
    public Order moveToForPickup(int queueNumber, int customerId) throws SQLException {
        return moveOrderByIdentifiers(queueNumber, customerId, "to_fold_orders", "for_pickup_orders", "for_pickup");
    }
    
    public Order moveToDeliver(int queueNumber, int customerId) throws SQLException {
        return moveOrderByIdentifiers(queueNumber, customerId, "to_fold_orders", "to_deliver_orders", "to_deliver");
    }
    
    public Order moveToClaimed(int queueNumber, int customerId) throws SQLException {
        return moveOrderByIdentifiers(queueNumber, customerId, "to_deliver_orders", "claimed_orders", "claimed");
    }
    
    public Order moveToClaimedFromPickup(int queueNumber, int customerId) throws SQLException {
        return moveOrderByIdentifiers(queueNumber, customerId, "for_pickup_orders", "claimed_orders", "claimed");
    }
    
    // ============================================================
    // GENERIC MOVE ORDER USING queueNumber + customerId
    // ============================================================
    private Order moveOrderByIdentifiers(int queueNumber, int customerId, String fromTable, String toTable, String newStatus) throws SQLException {
    ...
    // ============================================================
    // FIXED: UPDATE WEIGHT & PRICE USING queueNumber + customerId
    // ============================================================
